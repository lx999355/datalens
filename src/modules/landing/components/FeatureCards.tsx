  ...
  return (
    <section className="px-4 py-20">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-center text-foreground mb-4">核心功能</h2>
        ...
        <SpotlightGrid className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            <a key={feature.title} href={feature.href} className="block group">
              <GlassCard level={2} hover className="p-6 h-full cursor-pointer transition-all duration-300 group-hover:bg-white/[0.08] group-hover:border-primary/30 group-hover:shadow-[0_0_30px_rgba(96,165,250,0.15)]">
